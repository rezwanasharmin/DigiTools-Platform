...
=> **🔄 Live Tab Switching** – Seamless toggle between Products and Cart.
=> **🛍️ Interactive Product Cards** – "Buy Now" changes to "Added to Cart" with animation.
=> **🔔 Toast Notifications** – Using React Toastify for smooth feedback.
